  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%', backgroundColor: '#050505', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', fontFamily: 'sans-serif' }}>
        ...
        <div style={{ display: 'flex', gap: '2rem' }}>
          {code.map((digit, index) => (
            <div key={index} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#0a0a0a', padding: '1rem', borderRadius: '1rem', border: '1px solid rgba(255,105,180,0.2)', boxShadow: 'inset 0 0 20px rgba(0,0,0,1)' }}>
              ...
              <div style={{ height: '8rem', width: '6rem', overflow: 'hidden', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.9)', borderRadius: '0.5rem', borderTop: '4px solid #111', borderBottom: '4px solid #111', boxShadow: '0 0 15px rgba(255,105,180,0.1)' }}>
                <AnimatePresence mode="popLayout">
                  <motion.span
                    ...
                    style={{ position: 'absolute', fontSize: '4.5rem', fontWeight: '900', color: 'white', textShadow: '0 0 8px rgba(255,255,255,0.5)' }}
                  >
                    {digit}
                  </motion.span>
                </AnimatePresence>
      ...
      {isUnlocked && (
        ...
        >
          <h1 style={{ fontSize: '3.75rem', color: '#FF69B4', fontWeight: '900', letterSpacing: '0.1em', marginBottom: '1.5rem', textShadow: '0 0 25px rgba(255,105,180,0.8)' }}>
            VAULT UNLOCKED
          </h1>
